...
are overridden by settings in /etc/cementtests073/cementtests073.conf and/or
~/.cementtests073.conf (by default) and therefore, any default configurations
...
prefix = os.path.join(os.environ['HOME'], '.cementtests073')
    
dcf = ConfigObj() # default config
dcf['config_source'] = ['defaults']
dcf['app_name'] = 'cementtests073' # name for cli like /etc/<app_name>
dcf['app_egg_name'] = 'cementtests073' # name from setup.py
dcf['app_module'] = 'cementtests073' # name of the library dir
