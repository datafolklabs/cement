"""
This is the RootController for the cement-tests-073 application.  This can be used
...
from cementtests073.core.exc import cement-tests-073ArgumentError

log = get_logger(__name__)
config = get_config()

class RootController(CementController):
    @expose('cementtests073.templates.root.error', is_hidden=True)
    ...
    def default(self, *args, **kw):
        ...
        cementtests073, this one will be executed.  By default it raises an
        exception.
        
        """
        raise cement-tests-073ArgumentError, "A command is required. See --help?"
    
    @expose('cementtests073.templates.root.cmd1')
    def cmd1(self, *args, **kw):
        """This is an example 'root' command.  It should be replaced."""
        foo = 'In cementtests073.controllers.root.cmd1()'
    ...
    def cmd1_help(self, *args, **kw):
        ...
        foo = 'In cementtests073.controllers.root.cmd1_help()'
        return dict(foo=foo)
    
    @expose('cementtests073.templates.root.get-started')
