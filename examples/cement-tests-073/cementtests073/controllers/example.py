"""
This is the ExampleController for the cement-tests-073 application.  This can be used
to expose commands to the example namespace which will be accessible under:

    $ cementtests073 example --help
...
from cementtests073.model.example import ExampleModel
...
class ExampleController(CementController):
    ...
    def ex1(self, *args, **kw):
        ...
        # So if you have added cli options in your cement-tests-073.bootstrap.example
        ...
        # cementtests073.bootstrap.example:
    ...
    def ex1_help(self, *args, **kw):
        ...
        executed when you run:
            ...
            $ cementtests073 example ex1-help
        
        """
        print "This is the help method for ex1."
    
    @expose('cementtests073.templates.example.ex2', namespace='example')    
    def ex2(self, *args, **kw): 
        ...
        # cementtests073/bootstrap/example.py:
    ...
    def cmd2(self, *args, **kw):
        ...
        foo = "In cementtests073.controllers.example.cmd2()"
        print foo
        return dict(foo=foo)